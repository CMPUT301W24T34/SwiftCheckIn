...
public class OrgQRCodesInfoTest {
    ...
    public void checkQRCodeFragmentTest() {
        ...
        if (allowButton.waitForExists(3000)) {
            ...
            onView(withId(R.id.organizerEventInfo_qrButton)).perform(ViewActions.click());
            onView(withId(R.id.organizerEventInfo_CheckInQR)).check(matches(isDisplayed()));
        }
    }
