...
public class OrgMilestonesTest {
    ...
    @Test
    public void checkMilestoneTest() {
        ...
        if (allowButton.waitForExists(3000)) {
            ...
            onView(withId(R.id.organizerEventInfo_milestoneImage)).perform(ViewActions.click());
            onView(withId(R.id.milestone_firstSignUp)).check(matches(isDisplayed()));
        }
    }
